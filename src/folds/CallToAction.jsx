...
const CallToAction = () => {
    return (
        <div className='flex flex-col py-24 max-sm:py-16 items-center'>
            <span className='text-[#121417] text-center font-semibold text-4xl max-sm:text-3xl font-[Manrope] w-9/12'>
